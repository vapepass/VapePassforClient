    ...
    <div className="min-h-screen bg-white">
      <header className="sticky top-0 z-50 bg-white/95 backdrop-blur-sm border-b border-[#e5e5ec]">
        ...
        >
          ...
          <AnimateIn immediate animation="slide-down" delay={80} duration={400} className="flex items-center gap-4">
        ...
        <div className="max-w-[480px] mx-auto px-6 mb-16 sm:mb-20">
          <AnimateIn animation="scale-in" duration={600}>
            ...
            >
              ...
              <AnimateIn animation="fade-in" delay={200} duration={400}>
              ...
              <div className="flex justify-between mb-6 flex-nowrap relative" aria-hidden="true">
                {Array.from({ length: 10 }, (_, i) => (
                  <AnimateIn key={i} animation="scale-in" delay={280 + i * 50} duration={350} className="flex-shrink-0">
                    <div
                      className={[
              ...
              <AnimateIn animation="slide-up" delay={750} duration={400}>
        ...
        <div className="max-w-5xl mx-auto px-6 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-14 md:gap-20">
            {steps.map(({ n, title, desc }, i) => (
              <AnimateIn key={n} animation="slide-up" delay={i * 120}>
                ...
                <ul className="space-y-3 mb-8 flex-1">
                  {plan.features.map((f, i) => (
                    <AnimateIn
                      ...
                      delay={350 + i * 60}
                      duration={400}
                      className="flex items-center gap-2.5 text-sm text-[#111827]"
                    >
