...
export const demoStats = [
  ...
  { label: 'Active Passes', value: '612', change: '+12%', icon: 'wallet' },
  { label: 'Rewards Redeemed', value: '94', change: '+24%', icon: 'gift' },
  { label: 'Stamps This Month', value: '1,284', change: '+31%', icon: 'stamp' },
];
...
export const demoNotifications = [
  {
    ...
    body: 'Jordan Lee earned a free 30ml juice — 10/10 stamps complete.',
    time: 'Just now',
  },
  {
    id: 2,
    ...
    body: 'Double stamps on all disposables — Saturday & Sunday only.',
    time: '2 hrs ago',
  },
  {
    id: 3,
    type: 'reminder',
    title: 'Almost There',
    body: 'Riley Jackson is 1 stamp away from their free reward. Send a nudge?',
    time: '5 hrs ago',
  },
];
